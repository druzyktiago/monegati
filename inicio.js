...
// efeito do texto
  ...
  gsap.from(".sub-square h3", {
    duration: 1.5,
    rotationX: 90,
    transformOrigin: "top center",
    opacity: 0,
    stagger: 0.2, // Espaço de tempo entre cada animação
    ease: "power2.inOut",
    onComplete: function () {
      // Animando de volta para a posição normal
      gsap.to(".sub-square h3", {
        duration: 1.6,
        rotationX: 0,
        opacity: 1,
        transformOrigin: "top center",
